import { ArrowUpRight, DoorOpen, DollarSign, AlertCircle, Users, UserCheck, Clock } from "lucide-react";

type DashboardResumenProps = {
  cards: Array<{ label: string; value: string; detail: string; icon: typeof Users; tone: string }>;
  recentEntries: Array<{ nombre: string; dni: string; ingreso: string; estado: string }>;
  plansSummary: Array<{ nombre: string; total: number; porcentaje: number }>;
  sociosActivos: number;
  socios: Array<{ nombre: string; dni: string; telefono: string; plan: string; estado: "Activo" | "Suspendido" | "Inactivo"; vencimiento: string }>;
  onOpenIngresos: () => void;
};
